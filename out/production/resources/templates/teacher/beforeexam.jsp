    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="beforeexam.jsp">考前操作</a></li>
...
<div
    ...
    <h3 style="margin-left: 20px; margin-top: 20px">添加考试</h3>
    <div style="width: 200px; float: left">
        <input type="text" class="form-control"
               style="width: 200px; margin-left: 50px" placeholder="考试名称">
    </div>
    <div style="width: 200px; float: left; margin-left: 30px">
        <input type="date" class="form-control"
               style="width: 200px; margin-left: 50px" placeholder="考试时间">
    </div>
    <input type="checkbox" style="margin-left: 80px; margin-top: 10px"><span>自动开始</span>
    <button type="button" class="btn btn-default btn-lg"
            style="margin-left: 30px; margin-top: -5px">添加</button>
</div>
